...
var Head_default = /* @__PURE__ */ __name(() => {
  const Head = /* @__PURE__ */ __name(({
    ...
    const socialUrlEncoded = encodeURI(socialUrl);
    return /* @__PURE__ */ jsxs11("head", { children: [
      ...
      /* @__PURE__ */ jsx18("meta", { property: "og:locale", content: "ja_JP" }),
      /* @__PURE__ */ jsx18("meta", { "http-equiv": "Content-Type", content: "text/html; charset=utf-8" }),
      ...
      cfg.baseUrl && /* @__PURE__ */ jsxs11(Fragment4, { children: [
        ...
        /* @__PURE__ */ jsx18("meta", { property: "og:url", content: socialUrlEncoded }),
        /* @__PURE__ */ jsx18("meta", { name: "twitter:url", content: socialUrlEncoded })
      ] }),
...
var defaultContentPageLayout = {
  ...
  left: [
    ...
    //Component.Explorer(),
    Explorer_default({
      filterFn: /* @__PURE__ */ __name((f) => !f.slug.startsWith("_"), "filterFn"),
      // 既存フィルター（例）
      sortFn: /* @__PURE__ */ __name((a, b) => {
        return (b.dates?.modified ?? b.dates?.created ?? 0) - (a.dates?.modified ?? a.dates?.created ?? 0);
      }, "sortFn")
    })
  ],
  right: [
